  ...
  return (
    <header className="bg-zinc-950 text-gray-200 shadow-xl border-b border-zinc-800">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        {/* Mobile menu */}
        <div className={`md:hidden ${isMobileMenuOpen ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'} fixed inset-y-0 left-0 w-64 bg-zinc-900 transform transition-all duration-300 ease-in-out z-20`}>
